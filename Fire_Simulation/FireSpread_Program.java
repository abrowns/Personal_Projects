/*
	File: FireSpread_Program.java
		This file contains all the graphics handling for the animation and
...
public class FireSpread_Program extends JPanel implements ActionListener{
	...
	public static void main(String[] args) 
	{
		EventQueue.invokeLater(new Runnable() 
		{
			...
			public void run() 
			{
				FireSpread_Program simpG = new FireSpread_Program(grid);
	 ...
	 */
	public FireSpread_Program(World grid) {
		window.add(this);
